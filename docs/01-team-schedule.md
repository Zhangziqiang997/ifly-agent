...
gantt
    ...
    section A组（数据提取）
    学习 JSON Schema      :done,    a0, 07-25, 0.5d
...
```
07.24 (Day 1)              07.25 (Day 2)              07.26 (Day 3)          07.27-28 (Day 4-5)
─────────────────────────────────────────────────────────────────────────────────────────────

[PM] ──PRD──▶ ──竞品调研──▶ ──架构文档──▶ ──引擎调试──▶ ──UI──▶ ──PPT/脚本──▶ ★路演
                │                                     │
[A组]           ├─ JSON Schema学习 ──▶ 3人并行提取 ──▶│── 交叉验证 ──▶ 补充参数
                │   (串行: 先学后做)     (并行)        │    (串行)
                │                                     │
